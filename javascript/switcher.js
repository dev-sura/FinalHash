...
$(document).ready(function() {
   var e =  '<div class="switcher-container">'+
               '<h2>Style Selector<a href="#"><i class="icons-magic"></i></a></h2>'+
               '<div class="selector-box">'+
                  '<h3>Layout Style</h3>'+
                  '<div class="layout-switcher">'+
                     '<a id="multipages" href="index.html" class="layout current">MultiPages</a>'+
                     '<a id="onepage" href="index-onepage.html" class="layout">OnePage</a>'+
                  '</div>'+
